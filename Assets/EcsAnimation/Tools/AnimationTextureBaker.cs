...
namespace EcsAnimation.Tools
{
    public static class AnimationTextureBaker
    {
        ...
        public static BakedData BakeClips(GameObject animationRoot, AnimationClip[] animationClips, float framerate)
        {
            ...
            if (animationClips.Length == 0)
                throw new System.ArgumentException("There must be exactly one Animation Clip");
            ...
            {
                var sampledMatrix = SampleAnimationClip(instance, t, skinRenderer, bakedData.Framerate);
